...
insert into public.issues_project (name, sort_order) values
  ('REPLACE ME - Project 1', 1),
  ('REPLACE ME - Project 2', 2)
on conflict (name) do nothing;
...
insert into public.issues_user (first_name, last_name, email, sort_order) values
  ('REPLACE', 'ME - Person One', null, 1),
  ('REPLACE', 'ME - Person Two', null, 2)
...
cross join (values
  ('REPLACE ME - Category 1', 1),
  ('REPLACE ME - Category 2', 2),
  ('REPLACE ME - Category 3', 3)
